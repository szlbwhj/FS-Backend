    ...
    void proxy(String url, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (isHtml) {
                ...
                body = body.replaceAll("http://", ExpressService.URL_PROXY_DOMAIN + "?url=http://")
                        .replaceAll("src=\"//", "src=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + url_form.getProtocol() + "://")
                        .replaceAll("src=\"/", "src=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + url_form.getProtocol() + "://"
                                + url_form.getHost() + "/")
                        .replaceAll("src=\"(?!(htt(p|ps)))", "src=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + MiscUtils.getBase(url_form))
                        .replaceAll("href=\"http://", "href=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=http://")
                        .replaceAll("href=\"//", "href=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + url_form.getProtocol() + "://")
                        .replaceAll("href=\"/", "href=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + url_form.getProtocol() + "://"
                                + url_form.getHost() + "/")
                        .replaceAll("href=\"(?!(htt(p|ps)))", "href=\"" + ExpressService.URL_PROXY_DOMAIN + "?url=" + MiscUtils.getBase(url_form));
